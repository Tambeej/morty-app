    ...
    <div className="min-h-screen bg-navy flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-navy-surface border border-border rounded-card p-8 shadow-card">
          <h1 className="text-xl font-semibold text-white mb-2">Sign In to Morty</h1>
          <p className="text-slate-400 text-sm mb-6">AI-powered mortgage analysis</p>
          <p className="text-slate-500 text-sm text-center py-4">Login form — coming in Task 2</p>
        </div>
      </div>
    </div>
  );
